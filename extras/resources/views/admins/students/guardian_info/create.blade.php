...
@section('page_heading', 'Add Guardian Info')
@section('section')

{!! form_start($form) !!}
<div class="collection-container" data-prototype="{{ form_row($form->guardian->prototype()) }}">
    {!! form_row($form->guardian) !!}
    <hr/>
</div>

<button type="button" class="btn btn-labeled btn-primary add-to-collection"><span class="btn-label"><i class="fa fa-plus"></i></span>Add Another Guardian</button>
