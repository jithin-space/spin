...
@section('page_heading', 'Edit Profile Information')
...
<div class="form-group">
  <label for="Date_Of_Birth">Date Of Birth</label>
                <div class='input-group date' id='datetimepicker1'>
                    <input type='text' class="form-control" name="date_of_birth" value="{{$user->profile_info['date_of_birth']}}" required/>
...
<div class="form-group">
  <label for="Date_Of_Joining">Date Of Joining</label>
                <div class='input-group date' id='datetimepicker2'>
                    <input type='text' class="form-control" name="date_of_joining" value="{{$user->profile_info['date_of_joining']}}" required/>
                    <span class="input-group-addon">
                        <span class="glyphicon glyphicon-calendar"></span>
                    </span>
                </div>
